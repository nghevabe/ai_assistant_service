def content_parsing_img(result):
    analyze_str = result.split("#analysis_start#")[1]
    analyze_content = analyze_str.split("#analysis_end#")[0].strip()
...
def content_parsing_text(result):
    analyze_str = result.split("#step1_start#")[1]
    analyze_content = analyze_str.split("#step1_end#")[0].strip()
